...
mnist_training_images = idx2numpy.convert_from_file('mnist_data/train-images.idx3-ubyte')
mnist_test_images = idx2numpy.convert_from_file('mnist_data/t10k-images.idx3-ubyte')
...
mnist_training_labels = idx2numpy.convert_from_file('mnist_data/train-labels.idx1-ubyte')
mnist_test_labels = idx2numpy.convert_from_file('mnist_data/t10k-labels.idx1-ubyte')
...
batch = mnist_training_data[:10]
nn = NeuralNet([784,100,50,10])
'''

print(timeit.timeit(stmt='for i in range(10): nn.make_step(batch=batch ,eta=1.0)', setup=setup, number=10))